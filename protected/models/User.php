...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			// array('username,last_name,email,phone,company_name,total_market,select_plan','required','on'=>'register'),
			array('username,email','required','on'=>'register'),
			array('username,email,user_type,is_premium,is_activate','required','on'=>'create,update'),
            ...
            array('username,subscription_id,package_id,subscription_date,sub_period_start,sub_period_end','safe'),
            ...
            array('email','email'),
            array('email,username','required','on'=>'changeprofile'),
			...
			array('id, username, email, password, user_type,forgot_password_token,is_deleted,is_premium,is_activate,subscription_id,package_id,subscription_date,sub_period_start,sub_period_end', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('is_activate',$this->is_activate,true);
