                ...
                <div class="ibox-content">
                    ...
                    <div class="row" style="clear: both;">
						...
						<div class="form-group">
							<?php echo $form->labelEx($model,'conditions', array('class' => 'col-md-3 control-label')); ?>
							<div class="col-md-6">
								<?php echo $form->textField($model,'conditions',array('class' => 'form-control','size'=>60,'maxlength'=>255)); ?>
