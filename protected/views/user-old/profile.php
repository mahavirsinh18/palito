            ...
            <div class="ibox float-e-margins">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <?php echo $form->textField($model, 'phone', array('class' => 'form-control', 'size' => 60, 'maxlength' => 255,'data-mask'=>"999-999-9999")); ?>
                ...
                <div class="form-group">
                    ...
                    <?php echo $form->labelEx($model, 'company_name', array('class' => 'col-md-3 control-label')); ?>
